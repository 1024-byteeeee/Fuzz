...
public abstract class FogRendererMixin {
    ...
    @Shadow
    protected abstract CameraSubmersionType getCameraSubmersionType(Camera par1);
    ...
    private Vector4f modifyWaterFogColor(Vector4f original, Camera camera) {
        ...
        if (!Objects.equals(FuzzSettings.waterFogColor, "false") && cameraSubmersionType.equals(CameraSubmersionType.WATER)) {
            try {
