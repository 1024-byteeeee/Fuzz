...
public abstract class WaterRendererMixin {
    @WrapOperation(
        ...
        at = @At(
            value = "FIELD",
            target = "Lnet/minecraft/world/biome/BiomeEffects;waterColor:I",
            opcode = Opcodes.GETFIELD
        )
    )
    private int modifyWaterColor(BiomeEffects biomeEffects, Operation<Integer> original) {
        return
            Objects.equals(FuzzSettings.waterColor, "false") ?
            original.call(biomeEffects) :
