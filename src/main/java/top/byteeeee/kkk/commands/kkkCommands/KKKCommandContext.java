...
public abstract class KKKCommandContext {
    ...
    public static int showFunctionList(FabricClientCommandSource source) {
        ...
        messages.add(tr.tr("mod_version", KKKModClient.VERSION).formatted(Formatting.GRAY));
        ...
        for (Field field : KKKSettings.class.getDeclaredFields()) {
            if (field.isAnnotationPresent(KKKFunction.class)) {
                try {
                    ...
                    Object defaultValue = KKKSettings.DEFAULT_VALUES.get(field.getName());
                    ...
                    KKKModClient.LOGGER.error("Unable to access field {}: {}", field.getName(), e.getMessage());
                }
            }
        }
        ...
        messages.add(KKKCategories.tr.tr("categories_list").formatted(Formatting.GOLD, Formatting.BOLD));
        messages.add(KKKCategories.showCategories());
    ...
    public static int showAllFunctions(FabricClientCommandSource source) {
        ...
        List<Field> allFields = Arrays.stream(KKKSettings.class.getDeclaredFields())
        ...
        for (Field field : allFields) {
            try {
                ...
                KKKModClient.LOGGER.error("Field access error: {}", field.getName(), e);
            }
        }
    ...
    public static MutableText functionEntryText(Field field, Object value) {
        ...
        return Messenger.s("")
            ...
            .styled(style -> style.withHoverEvent(HoverEventUtil.event(
                ...
                ClickEventUtil.event(ClickEventUtil.RUN_COMMAND, "/kkk " + field.getName())
            ))
            .append(valueDisplay);
    }
    ...
    public static int showFunctionInfo(FabricClientCommandSource source, Field field) {
        ...
        try {
            ...
            Object currentValue = field.get(null);
            Object defaultValue = KKKSettings.DEFAULT_VALUES.get(field.getName());
            KKKFunction annotation = field.getAnnotation(KKKFunction.class);
            ...
            int extraIndex = 0;
            while (true) {
                String extraKey = "kkk.settings." + field.getName() + ".extra." + extraIndex;
            ...
            for (String category : annotation.categories()) {
                ...
                if (LanguageJudge.isEnglish()) {
                    hoverText = tr.tr("function_info_click_to_view", KKKCategories.tr.tr(category)).formatted(Formatting.YELLOW);
                } else {
                    hoverText = tr.tr("function_info_click_to_view", KKKCategories.tr.tr(category), category).formatted(Formatting.YELLOW);
                }
                categoriesLine.append(
                    Messenger.s("[" + KKKCategories.tr.tr(category).getString() + "]")
    ...
    public static MutableText optionText(Field field, Object value) {
        ...
        Object defaultValueObj = KKKSettings.DEFAULT_VALUES.get(field.getName());
            ...
            MutableText customButton = Messenger.s("[" + currentValue + "]")
                ...
                .styled(style -> style
                    ...
                    .withClickEvent(
                        ...
                        ClickEventUtil.RUN_COMMAND,
                        "/kkk " + field.getName() + " " + currentValue
                    ))
                    .withHoverEvent(HoverEventUtil.event(
                        HoverEventUtil.SHOW_TEXT,
