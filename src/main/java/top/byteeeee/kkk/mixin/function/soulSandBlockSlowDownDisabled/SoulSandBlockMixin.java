...
package top.byteeeee.kkk.mixin.function.soulSandBlockSlowDownDisabled;
...
public abstract class SoulSandBlockMixin extends Block {
    ...
    public float getVelocityMultiplier() {
        return KKKSettings.soulSandBlockSlowDownDisabled ? Blocks.GRAY_CONCRETE.getVelocityMultiplier() : super.getVelocityMultiplier();
    }
}
