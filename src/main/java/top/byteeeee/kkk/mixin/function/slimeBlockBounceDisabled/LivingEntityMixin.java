...
package top.byteeeee.kkk.mixin.function.slimeBlockBounceDisabled;
...
public abstract class LivingEntityMixin {
    ...
    private float slimeSlipperinessDisabled(Block block, Operation<Float> original) {
        ...
        if (KKKSettings.slimeBlockSlowDownDisabled && entity.equals(ClientUtil.getCurrentPlayer()) && block.equals(Blocks.SLIME_BLOCK)) {
