...
package top.byteeeee.kkk.mixin.function.iceSlipperinessDisabled;
...
import top.byteeeee.kkk.helpers.function.iceSlipperinessDisabled.IceFamily;
...
public abstract class LivingEntityMixin {
    ...
    private float iceSlipperinessDisabled(Block block, Operation<Float> original) {
        ...
        if (KKKSettings.iceSlipperinessDisabled && entity.equals(ClientUtil.getCurrentPlayer()) && IceFamily.isIce(block)) {
